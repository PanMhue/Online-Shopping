...
<main class="container flex justify-center items-start mt-4 mx-auto">
    <div class="w-[60%] flex flex-col gap-5 mx-auto">
        <div class="flex justify-between items-center w-full py-5">
            ...
            <a href="item_new.php" class="new text-3xl bg-gray-300 px-4 pb-2 pt-1 text-center rounded-full">+</a>
        </div>
        <?php while($row=mysqli_fetch_assoc($result)){ ?>
            <div class="flex justify-between items-center border-b-4 max-h-[150px] pb-4 min-h-[75px] ps-3">
                <div class="flex flex-row gap-3 items-center">
                    <img src="images/<?php echo $row['photo']?>" alt="" align="right" height="75" width="75" class="object-contain">
                    <div>
                ...
                <div class="flex flex-row h-full">
                    <a class="w-full h-full px-5 py-2 bg-gray-500 inline-block text-white rounded-s-2xl"  href="item_edit.php?id=<?php echo $row['id']?>">
                    ...
                    <a class="w-full h-full px-5 py-2 bg-red-500 inline-block text-white rounded-e-2xl"  href="item_delete.php?id=<?php echo $row['id']?>" onClick="return confirm('Are you sure?')">
                        <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
